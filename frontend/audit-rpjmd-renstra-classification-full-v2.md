...
Perbaikan v2: logika `if/return/api` tanpa string UI tidak lagi ditandai `HARUS DIUBAH`; komponen header `GlobalDokumenTahun*` dikelompokkan `PERLU VALIDASI` (lintas modul).
...
| `frontend\src\contexts\DokumenProvider.jsx` | 16 | const initialTahun = isFreshSsoSession | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\contexts\DokumenProvider.jsx` | 35 | const setTahunGlobal = useCallback((th) => { | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\contexts\DokumenProvider.jsx` | 36 | setTahun(th); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\contexts\DokumenProvider.jsx` | 38 | sessionStorage.setItem("tahun", th); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\contexts\DokumenProvider.jsx` | 39 | localStorage.setItem("tahun", th); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\contexts\DokumenProvider.jsx` | 48 | setTahun(""); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\contexts\DokumenProvider.jsx` | 61 | setTahun: setTahunGlobal, | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\renstra\components\FormCascadingRenstra.jsx` | 104 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\components\FormRenstraOPD.jsx` | 242 | <Select {...field} allowClear placeholder="Pilih Tahun Mulai"> | UI_LABEL | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\renstra\components\FormRenstraOPD.jsx` | 244 | <Select.Option key={p.tahun_awal} value={p.tahun_awal}> | DOMAIN_DATA | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\components\FormRenstraOPD.jsx` | 263 | <Select {...field} allowClear placeholder="Pilih Tahun Akhir"> | UI_LABEL | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\renstra\components\FormRenstraOPD.jsx` | 265 | <Select.Option key={p.tahun_akhir} value={p.tahun_akhir}> | DOMAIN_DATA | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\indikator\umumRentra\pages\indikatorUmumRenstraAddPage.jsx` | 7 | const { tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\kebijakan\components\kebijakanRenstraForm.jsx` | 50 | setValue("tahun", selected?.tahun \|\| ""); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\renstra\kebijakan\components\kebijakanRenstraForm.jsx` | 67 | setValue("tahun", initialData.tahun); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\kegiatan\components\RenstraTabelKegiatanForm.jsx` | 179 | const handlePaguChange = (tahun, value) => { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\renstra\kegiatan\components\RenstraTabelKegiatanForm.jsx` | 180 | setInputPagu((prev) => ({ ...prev, [tahun]: Number(value \|\| 0) })); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\pages\DynamicBabPage.jsx` | 40 | export default function DynamicBabPage({ tahun }) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\pages\DynamicBabPage.jsx` | 158 | fileName = `Bab_${babId}_${tahun}.pdf`, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\renstra\pages\DynamicBabPage.jsx` | 337 | saveAs(blob, `Bab_${babId}_${tahun}.docx`); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\renstra\pages\DynamicBabPage.jsx` | 371 | saveAs(blob, `Bab_${babId}_${tahun}.xlsx`); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\pages\RenstraDashboard.jsx` | 29 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\renstra\pages\RenstraDashboard.jsx` | 135 | const paguPerTahun = [1, 2, 3, 4, 5, 6].map((i) => ({ | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\features\renstra\pages\TargetRenstra.jsx` | 5 | const [years, setYears] = useState([]); // Tahun otomatis dari backend | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\pages\TargetRenstraList.jsx` | 95 | <td>{t.tahun \|\| "-"}</td> | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\shared\components\RenstraTabelListCommon.jsx` | 17 | export function TahunGrid({ record, prefix, label }) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\renstra\shared\components\RenstraTabelListCommon.jsx` | 91 | <TahunGrid record={record} prefix="target" label="Target per slot periode (th. ke-1 s/d ke-6)" /> | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\renstra\shared\components\RenstraTabelListCommon.jsx` | 92 | <TahunGrid record={record} prefix="pagu" label="Pagu per slot periode (th. ke-1 s/d ke-6, Rp)" /> | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\features\renstra\utils\exportRenstra.js` | 14 | "Acuan (kalender)": t.tahun, | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\components\AktivitasFilter.jsx` | 36 | <option value="tahun">Agregat tahunan (log aktivitas)</option> | UI_LABEL | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\features\rpjmd\components\IndikatorSimpleEditFormBody.jsx` | 28 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\rpjmd\components\RpjmdDokumenImporPanel.jsx` | 227 | <td>{r.tahun_2021}</td> | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\components\RpjmdDokumenImporPanel.jsx` | 228 | <td>{r.tahun_2022}</td> | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\components\RpjmdDokumenImporPanel.jsx` | 229 | <td>{r.tahun_2023}</td> | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\components\RpjmdDokumenImporPanel.jsx` | 230 | <td>{r.tahun_2024}</td> | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\components\RpjmdDokumenImporPanel.jsx` | 231 | <td>{r.tahun_2025}</td> | DOMAIN_DATA | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\subhooks\useFetchPrograms.js` | 5 | export default function useFetchPrograms(tahun, jenis_dokumen = "rpjmd") { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\subhooks\useReferenceData.js` | 55 | const { rpjmd_id, tahun, opd_penanggung_jawab, sasaran_id, jenis_dokumen } = | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\useKegiatanFormLogic.js` | 50 | const { tahun, jenis_dokumen } = kegiatanData; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\useKegiatanFormLogic.js` | 192 | { tahun, jenis_dokumen }, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\hooks\useKegiatanFormLogic.js` | 195 | }, [programs, programsLoading, tahun, jenis_dokumen]); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\hooks\useKegiatanFormLogic.js` | 206 | tahun, | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\usePeriodeAktif.jsx` | 21 | const { dokumen, tahun, loading: docLoading, setTahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\usePeriodeAktif.jsx` | 85 | return currentYear >= tahunAwal && currentYear <= tahunAkhir; | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\rpjmd\hooks\usePeriodeAktif.jsx` | 101 | : `Tidak dapat menemukan periode aktif untuk konteks saat ini (${tahun}).`, | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\useProgramFormLogic.jsx` | 88 | if (isEdit && detail && periode_id && tahun && !initializedRef.current) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\useSubKegiatanFormLogic.js` | 44 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\hooks\useSubKegiatanFormLogic.js` | 95 | if (dokumen && tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\hooks\useSubKegiatanFormLogic.js` | 98 | }, [dokumen, tahun]); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\hooks\useSubKegiatanFormLogic.js` | 101 | if (existingData && programList.length > 0 && dokumen && tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\DashboardHome.jsx` | 12 | import { useRequireDokumenTahun } from "../../../hooks/useRequireDokumenTahun.jsx"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\DashboardMonitoring.jsx` | 195 | <option value="tahun">Agregat tahunan (monitoring)</option> | UI_LABEL | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\rpjmd\pages\DashboardMonitoring.jsx` | 208 | : timeType === "tahun" | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\pages\dashboardMonitoringRpjmd.jsx` | 92 | Realisasi: {r.nilai} – {r.tahun} | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\pages\dashboardMonitoringRpjmd.jsx` | 108 | Realisasi: {r.nilai} – {r.tahun} | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\pages\DashboardUtamaRpjmd.jsx` | 337 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\DashboardUtamaRpjmd.jsx` | 484 | if (dokumen && tahun && periode_id) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\IndikatorKegiatanEditPage.jsx` | 43 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\features\rpjmd\pages\IndikatorKegiatanEditPage.jsx` | 124 | const { program_id, tahun, jenis_dokumen } = initialValues \|\| {}; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\IndikatorKegiatanEditPage.jsx` | 127 | fetchIndikatorProgramOptions({ program_id, tahun, jenis_dokumen }) | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\pages\IndikatorKegiatanList.jsx` | 14 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\IndikatorProgramList.jsx` | 14 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\IndikatorSasaranListPage.jsx` | 14 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\IndikatorSasaranNestedView.jsx` | 15 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\IndikatorTujuanListPage.jsx` | 13 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\ReportRPJMDPage.jsx` | 30 | const [year, setYear] = useState(() => new Date().getFullYear()); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\ReportRPJMDPage.jsx` | 38 | } else if (ctxTahun) { | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\features\rpjmd\pages\ReportRPJMDPage.jsx` | 39 | const n = parseInt(String(ctxTahun), 10); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\features\rpjmd\pages\ReportRPJMDPage.jsx` | 42 | }, [dokumen, ctxTahun, periodeAktif]); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\features\rpjmd\pages\ReportRPJMDPage.jsx` | 97 | `laporan_rpjmd_${opdId}_${year}.json` | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\ReportRPJMDPage.jsx` | 101 | `laporan_rpjmd_${opdId}_${year}.pdf` | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\pages\ReportRPJMDPage.jsx` | 105 | `laporan_rpjmd_${opdId}_${year}.xlsx` | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\services\indikatorRpjmdApi.js` | 76 | export async function fetchWizardHierarchyOptions({ jenis_dokumen, tahun }) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\features\rpjmd\services\indikatorRpjmdApi.js` | 77 | const defaultParams = { jenis_dokumen, tahun }; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\services\indikatorRpjmdApi.js` | 398 | * @param {object} params - { sasaran_id, kegiatan_id, tahun, jenis_dokumen, ... } | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\utils\urusanKinerja228Picklists.js` | 17 | export function unionYearColumnsOptions(rows) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\features\rpjmd\utils\urusanKinerja228Picklists.js` | 70 | export function extrapolateCapaianTahun5FromFour(c1, c2, c3, c4) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\ArahKebijakanForm.jsx` | 18 | import { getPeriodeIdFromTahun } from "./utils/periodeUtils"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\ArahKebijakanForm.jsx` | 32 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\ArahKebijakanForm.jsx` | 280 | {konteksBannerRows(dokumen, tahun, periodeAktifBanner).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\ArahKebijakanList.jsx` | 39 | const { dokumen, tahun } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\CascadingForm.jsx` | 239 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\CascadingForm.jsx` | 573 | ? "Atur jenis dokumen di header. RPJMD/Renstra memakai satu periode (lima tahun); tidak perlu memilih tahun terpisah." | UI_LABEL | AMAN | BIARKAN |
| `frontend\src\shared\components\CascadingForm.jsx` | 605 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\CascadingList.jsx` | 167 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\CascadingList.jsx` | 296 | XLSX.writeFile(wb, `cascading_${String(dokumen \|\| "").toUpperCase()}_${tahun}.xlsx`); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\CascadingList.jsx` | 329 | if (!dokumen \|\| !tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\CascadingList.jsx` | 334 | ? "Atur jenis dokumen di header. RPJMD/Renstra memakai periode lima tahun (acuan internal otomatis)." | UI_LABEL | AMAN | BIARKAN |
...
| `frontend\src\shared\components\CascadingList.jsx` | 446 | filename={`cascading_${String(dokumen \|\| "").toUpperCase()}_${tahun}.csv`} | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\CascadingList.jsx` | 485 | <p>Belum ada data cascading untuk {String(dokumen \|\| "").toUpperCase()} tahun {tahun}.</p> | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\GlobalDokumenTahunPicker.jsx` | 28 | export default function GlobalDokumenTahunPicker() { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\GlobalDokumenTahunPicker.jsx` | 29 | const { dokumen, tahun, setDokumen, setTahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\GlobalDokumenTahunPicker.jsx` | 35 | const [localThn, setLocalThn] = useState(tahun \|\| ""); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\GlobalDokumenTahunPicker.jsx` | 74 | setTahun(thn); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\GlobalDokumenTahunPicker.jsx` | 85 | if (submitting && dokumen?.toLowerCase() === dok && tahun === thn) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\GlobalDokumenTahunPickerModal.jsx` | 1 | // src/shared/components/GlobalDokumenTahunPickerModal.jsx | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\shared\components\GlobalDokumenTahunPickerModal.jsx` | 31 | export default function GlobalDokumenTahunPickerModal({ forceOpen }) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\GlobalDokumenTahunPickerModal.jsx` | 32 | const { dokumen, tahun, setDokumen, setTahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\GlobalDokumenTahunPickerModal.jsx` | 140 | setTahun(thn); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\GlobalDokumenTahunPickerModal.jsx` | 190 | {tahunList.map((th) => ( | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\hooks\useAutoIsiTahunDanTarget.js` | 1 | // src/shared/hooks/useAutoIsiTahunDanTarget.js | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\shared\components\hooks\useIndikatorBuilder.js` | 9 | const getTargetTahunValues = (values) => | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\shared\components\IndikatorKhususListPage.jsx` | 38 | const { tahun, dokumen } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\IndikatorList.jsx` | 93 | { header: "Target (th. ke-1)", key: "target_tahun_1" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 94 | { header: "Target (th. ke-2)", key: "target_tahun_2" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 95 | { header: "Target (th. ke-3)", key: "target_tahun_3" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 96 | { header: "Target (th. ke-4)", key: "target_tahun_4" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 97 | { header: "Target (th. ke-5)", key: "target_tahun_5" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 98 | { header: "Capaian (th. ke-1)", key: "capaian_tahun_1" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 99 | { header: "Capaian (th. ke-2)", key: "capaian_tahun_2" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 100 | { header: "Capaian (th. ke-3)", key: "capaian_tahun_3" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 101 | { header: "Capaian (th. ke-4)", key: "capaian_tahun_4" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 102 | { header: "Capaian (th. ke-5)", key: "capaian_tahun_5" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 117 | { header: "Acuan (kalender)", key: "tahun" }, | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 168 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\IndikatorList.jsx` | 323 | `${selectedType}-indikator-${docLabel}-${tahun}.xlsx` | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 496 | {scalarCell(i[`capaian_tahun_${n}`])} | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorList.jsx` | 501 | {scalarCell(i[`target_tahun_${n}`])} | DOMAIN_DATA | AMAN | BIARKAN |
...
| `frontend\src\shared\components\IndikatorRPJMDForm.jsx` | 332 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\IndikatorRPJMDForm.jsx` | 451 | fetchWizardHierarchyOptions({ jenis_dokumen: dokumen, tahun }) | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorRPJMDForm.jsx` | 464 | }, [dokumen, tahun]); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\IndikatorRPJMDForm.jsx` | 471 | const res = await fetchTujuan({ jenis_dokumen: dokumen, tahun }); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\IndikatorTabContent.jsx` | 293 | placeholder={`Pilih dari impor (${uruCol.replace("tahun_", "")})`} | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\shared\components\IndikatorTabContent.jsx` | 359 | Otomatis: rata-rata berbobot <strong>1&nbsp;: 2&nbsp;: 3&nbsp;: 4</strong> pada Capaian Tahun 1–4 (tahun | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\KegiatanForm.jsx` | 50 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\KegiatanForm.jsx` | 104 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\KegiatanForm.jsx` | 175 | name="tahun" | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\KegiatanForm.jsx` | 176 | value={kegiatanData.tahun \|\| ""} | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\MisiForm.jsx` | 26 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\MisiForm.jsx` | 204 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\MuiSidebarGlobal.jsx` | 73 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\MuiSidebarGlobal.jsx` | 74 | const locked = !dokumen \|\| !tahun; | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\MuiTopbarGlobal.jsx` | 7 | import GlobalDokumenTahunPicker from "./GlobalDokumenTahunPicker"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\MuiTopbarGlobal.jsx` | 8 | import GlobalDokumenTahunPickerModal from "./GlobalDokumenTahunPickerModal"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\MuiTopbarGlobal.jsx` | 27 | {/* Left: Dokumen/Tahun Picker */} | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\MuiTopbarGlobal.jsx` | 28 | <GlobalDokumenTahunPicker /> | UI_FILTER | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\MuiTopbarGlobal.jsx` | 30 | {/* Right: Modal trigger (Ganti Dokumen/Tahun), avatar, dsb */} | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\MuiTopbarGlobal.jsx` | 32 | <GlobalDokumenTahunPickerModal /> | UI_FILTER | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\PrioritasDaerahForm.jsx` | 22 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasDaerahForm.jsx` | 104 | tahun, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasDaerahForm.jsx` | 145 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasDaerahList.jsx` | 22 | const { dokumen, tahun, loading: periodeLoading } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\PrioritasGubernurForm.jsx` | 36 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasGubernurForm.jsx` | 164 | tahun, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasGubernurForm.jsx` | 203 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasGubernurList.jsx` | 30 | const { dokumen, tahun, loading: periodeLoading } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasGubernurList.jsx` | 50 | if (!dokumen \|\| !tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasGubernurList.jsx` | 64 | tahun, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasGubernurList.jsx` | 80 | }, [reloadKey, dokumen, tahun, periodeLoading]); // Fetch ulang ketika reloadKey berubah | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasNasionalForm.jsx` | 20 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasNasionalForm.jsx` | 68 | const payload = { ...formData, dokumen, tahun }; | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasNasionalForm.jsx` | 109 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\PrioritasNasionalList.jsx` | 33 | const { dokumen, tahun, loading: periodeLoading } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 4 | import GlobalDokumenTahunPickerModal from "./GlobalDokumenTahunPickerModal"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 12 | export default function RequireDokumenTahun({ children }) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 13 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 26 | <GlobalDokumenTahunPickerModal forceOpen /> | UI_FILTER | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 32 | if (!tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 46 | <GlobalDokumenTahunPickerModal forceOpen /> | UI_FILTER | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 53 | if (!tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\RequireDokumenTahun.jsx` | 63 | <GlobalDokumenTahunPickerModal forceOpen /> | UI_FILTER | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\RPJMDList.jsx` | 101 | <th>Tahun Penetapan</th> | UI_LABEL | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\RPJMDList.jsx` | 114 | <td>{item.tahun_penetapan}</td> | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\RpjmdMetadataForm.jsx` | 10 | tahun_penetapan: "", | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\RpjmdMetadataForm.jsx` | 33 | tahun_penetapan: data.tahun_penetapan ?? "", | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\RpjmdMetadataForm.jsx` | 99 | <Form.Label>Tahun Penetapan</Form.Label> | UI_LABEL | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\RpjmdMetadataForm.jsx` | 101 | name="tahun_penetapan" | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\RpjmdMetadataForm.jsx` | 102 | value={form.tahun_penetapan} | DOMAIN_DATA | AMAN | BIARKAN |
...
| `frontend\src\shared\components\SasaranForm.jsx` | 310 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\SasaranList.jsx` | 65 | const { dokumen, tahun, periode_id, periodeList } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\SasaranList.jsx` | 138 | : `TAHUN ${tahunJudul}`; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\SidebarMenu.jsx` | 71 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\ArahKebijakanStep.jsx` | 41 | const { periode_id, tahun } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\ArahKebijakanStep.jsx` | 47 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\steps\ArahKebijakanStep.jsx` | 51 | if (tahun && !values.tahun) setFieldValue("tahun", tahun); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\indikatorStep\useStepTemplateAddAndAi.js` | 9 | import { extrapolateCapaianTahun5FromFour } from "@/features/rpjmd/utils/urusanKinerja228Picklists"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\indikatorStep\useStepTemplateAddAndAi.js` | 33 | text: "Periode atau tahun belum tersedia.", | UI_LABEL | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\indikatorStep\useStepTemplateAddAndAi.js` | 67 | text: `Capaian Tahun ${i} harus berupa angka yang valid.`, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\indikatorStep\useStepTemplateAddAndAi.js` | 75 | text: `Target Tahun ${i} harus berupa angka yang valid.`, | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\indikatorStep\useStepTemplateData.js` | 135 | ...(tahun != null && tahun !== "" ? { tahun } : {}), | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\KegiatanStep.jsx` | 48 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\steps\KegiatanStep.jsx` | 95 | const { program_id, tahun, jenis_dokumen } = values; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\ProgramStep.jsx` | 58 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\shared\components\steps\ProgramStep.jsx` | 100 | String(prev.tahun ?? "") !== String(snap.tahun ?? "")) | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\ReadOnlyIndikatorPreview.jsx` | 58 | <th>{`Target Tahun ${i}`}</th> | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\ReadOnlyIndikatorPreview.jsx` | 59 | <td>{data[`target_tahun_${i}`]}</td> | DOMAIN_DATA | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\ReadOnlyIndikatorPreview.jsx` | 64 | <th>{`Capaian Tahun ${i}`}</th> | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\ReusableStepTemplate.jsx` | 186 | <th key={i}>{`Tahun ${i}`}</th> | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\SasaranStep.jsx` | 50 | const { periode_id, tahun } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\SasaranStep.jsx` | 53 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\steps\SasaranStep.jsx` | 60 | if (tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\SasaranStep.jsx` | 61 | if (!values.tahun) setFieldValue("tahun", tahun); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\SasaranStep.jsx` | 337 | if (!values.periode_id \|\| !values.tahun \|\| !values.jenis_dokumen) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\SasaranStep.jsx` | 338 | toast.error("Periode, tahun, atau jenis dokumen belum lengkap."); | UI_LABEL | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\StrategiStep.jsx` | 41 | const { periode_id, tahun } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\StrategiStep.jsx` | 47 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\steps\StrategiStep.jsx` | 51 | if (tahun && !values.tahun) setFieldValue("tahun", tahun); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\SubKegiatanStep.jsx` | 37 | const { periode_id, tahun } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\SubKegiatanStep.jsx` | 40 | useAutoIsiTahunDanTarget(values, setFieldValue); | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\shared\components\steps\TujuanStep.jsx` | 62 | const { periode_id, tahun, loading: loadingPeriode } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\TujuanStep.jsx` | 77 | if (tahun && values.tahun !== tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\TujuanStep.jsx` | 78 | setFieldValue("tahun", tahun); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\TujuanStep.jsx` | 296 | if (!values.tahun \|\| !values.jenis_dokumen) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\TujuanStep.jsx` | 361 | if (!values.periode_id \|\| !values.tahun \|\| !values.jenis_dokumen) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\steps\TujuanStep.jsx` | 362 | toast.error("Periode, tahun, atau jenis dokumen belum lengkap."); | UI_LABEL | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\wizardIndikatorStepUtils.js` | 214 | "tahun", | DOMAIN_DATA | AMAN | BIARKAN |
...
| `frontend\src\shared\components\steps\wizardIndikatorStepUtils.js` | 311 | "tahun", | DOMAIN_DATA | AMAN | BIARKAN |
...
| `frontend\src\shared\components\StrategiForm.jsx` | 145 | const { sasaran_id, jenis_dokumen, tahun } = formData; | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\StrategiList.jsx` | 39 | const { dokumen, tahun } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\StrategiList.jsx` | 101 | if (dokumen && tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\SubKegiatanForm.jsx` | 28 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\SubKegiatanForm.jsx` | 112 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\TablerTopbarGlobal.jsx` | 4 | import GlobalDokumenTahunPicker from "./GlobalDokumenTahunPicker"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\TablerTopbarGlobal.jsx` | 5 | import GlobalDokumenTahunPickerModal from "./GlobalDokumenTahunPickerModal"; | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\TablerTopbarGlobal.jsx` | 23 | <GlobalDokumenTahunPicker /> | UI_FILTER | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\TablerTopbarGlobal.jsx` | 24 | <GlobalDokumenTahunPickerModal /> | UI_FILTER | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
| `frontend\src\shared\components\TujuanForm.jsx` | 80 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\TujuanForm.jsx` | 265 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\TujuanList.jsx` | 56 | const { dokumen, tahun } = usePeriodeAktif(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\TujuanList.jsx` | 244 | doc.text(`DAFTAR TUJUAN RPJMD TAHUN ${tahun}`, 14, 15); | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\utils\periodeUtils.js` | 2 | export const getPeriodeIdFromTahun = (tahun, periodeList) => { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\utils\renstraTabelKegiatanSchema.js` | 45 | `max-available-tahun-${i}`, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\utils\renstraTabelKegiatanSchema.js` | 46 | `❌ Pagu Tahun ${i} melebihi sisa pagu program`, | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\VisiForm.jsx` | 14 | const { dokumen, tahun } = useDokumen(); | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\VisiForm.jsx` | 31 | tahun: tahun, | INTERNAL_TEKNIS | AMAN | BIARKAN |
| `frontend\src\shared\components\VisiForm.jsx` | 44 | if (dokumen && tahun) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\shared\components\VisiForm.jsx` | 120 | {konteksBannerRows(dokumen, tahun, periodeAktif).map((r) => ( | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\utils\planningDokumenUtils.js` | 28 | const periodeMemuatTahun = (y) => | UNKNOWN | PERLU VALIDASI | ESKALASI VALIDASI PRODUK |
...
| `frontend\src\utils\planningDokumenUtils.js` | 55 | export function tahunDalamPeriode(tahunStr, periode) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\utils\planningDokumenUtils.js` | 68 | * @param {unknown} tahun nilai acuan API (biasanya tahun awal periode) | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\utils\planningDokumenUtils.js` | 72 | export function konteksBannerRows(dokumen, tahun, periodeAktif) { | INTERNAL_TEKNIS | AMAN | BIARKAN |
...
| `frontend\src\utils\planningDokumenUtils.js` | 87 | value: tahun != null && tahun !== "" ? String(tahun) : "—", | INTERNAL_TEKNIS | AMAN | BIARKAN |