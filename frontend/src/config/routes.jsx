...
import IndikatorKegiatanRenstraListPage from '@/features/renstra/indikator/kegiatan/pages/IndikatorKegiatanRenstraListPage';
import IndikatorKegiatanRenstraAddPage from '@/features/renstra/indikator/kegiatan/pages/indikatorKegiatanRenstraAddPage';
import IndikatorKegiatanRenstraEditPage from '@/features/renstra/indikator/kegiatan/pages/indikatorKegiatanRenstraEditPage';
import IndikatorSubKegiatanRenstraListPage from '@/features/renstra/indikator/subkegiatan/pages/IndikatorSubKegiatanRenstraListPage';
import IndikatorSubKegiatanRenstraAddPage from '@/features/renstra/indikator/subkegiatan/pages/indikatorSubKegiatanRenstraAddPage';
import IndikatorSubKegiatanRenstraEditPage from '@/features/renstra/indikator/subkegiatan/pages/indikatorSubKegiatanRenstraEditPage';
import SubkegiatanRenstraAddPage from '@/features/renstra/subkegiatan/pages/subkegiatanRenstraAddPage';
import SubkegiatanRenstraEditPage from '@/features/renstra/subkegiatan/pages/subkegiatanRenstraEditPage';
...
const routes = [
  ...
  {
    path: '/renstra/indikator',
    element: <IndikatorRenstraListPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  // 📊 Indikator Renstra - Tujuan
  {
    path: '/renstra/indikator/tujuan',
    element: <IndikatorTujuanRenstraListPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/tujuan/add',
    element: <IndikatorTujuanRenstraAddPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/tujuan/edit/:id',
    element: <IndikatorTujuanRenstraEditPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  // 📊 Indikator Renstra - Sasaran
  {
    path: '/renstra/indikator/sasaran',
    element: <IndikatorSasaranRenstraListPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/sasaran/add',
    element: <IndikatorSasaranRenstraAddPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
  ...
  // 📊 Indikator Renstra - Program
  {
    ...
    element: <IndikatorProgramRenstraListPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/program/add',
    element: <IndikatorProgramRenstraAddPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/program/edit/:id',
    element: <IndikatorProgramRenstraEditPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  // 📊 Indikator Renstra - Kegiatan
  {
    path: '/renstra/indikator/kegiatan',
    element: <IndikatorKegiatanRenstraListPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/kegiatan/add',
    element: <IndikatorKegiatanRenstraAddPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/kegiatan/edit/:id',
    element: <IndikatorKegiatanRenstraEditPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  // 📊 Indikator Renstra - Sub Kegiatan
  {
    path: '/renstra/indikator/subkegiatan',
    element: <IndikatorSubKegiatanRenstraListPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/indikator/subkegiatan/add',
    element: <IndikatorSubKegiatanRenstraAddPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
  ...
  {
    path: '/renstra/subkegiatan',
    element: <SubkegiatanRenstraListPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
    path: '/renstra/subkegiatan/add',
    element: <SubkegiatanRenstraAddPage />,
    role: ['SUPER_ADMIN', 'ADMINISTRATOR'],
  },
  {
