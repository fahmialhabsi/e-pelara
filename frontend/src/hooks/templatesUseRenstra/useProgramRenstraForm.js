// frontend/src/features/renstra/program/hooks/useProgramRenstraForm.js
...
export const useProgramRenstraForm = (initialData = null, renstraAktif = {}) => {
  return useRenstraFormTemplate({
    ...
    fetchOptions: {
      ...
      'program-rpjmd': () =>
        api.get(`/renstra-program?renstra_id=${renstraAktif?.id || ''}`).then((res) => res.data),
    },
  });
};
