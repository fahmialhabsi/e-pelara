...
const ListRenstraOPD = React.lazy(() => import('../features/renstra/pages/ListRenstraOPD'));
const RenstraRpjmdLinkTesterPage = React.lazy(
  () => import('../features/renstra/audit/pages/RenstraRpjmdLinkTesterPage'),
);
const FormRenstraOPD = React.lazy(() => import('../features/renstra/components/FormRenstraOPD'));
...
const DynamicBabPage = React.lazy(() => import('../features/renstra/pages/DynamicBabPage'));
...
const RenstraReviewKonsistensiListPage = React.lazy(
  () => import('../features/renstra/review/pages/RenstraReviewKonsistensiListPage'),
);
const RenstraReviewKonsistensiAddPage = React.lazy(
  () => import('../features/renstra/review/pages/RenstraReviewKonsistensiAddPage'),
);
const RenstraReviewKonsistensiEditPage = React.lazy(
  () => import('../features/renstra/review/pages/RenstraReviewKonsistensiEditPage'),
);
...
const IndikatorUmumRenstraAddPage = React.lazy(
  () => import('../features/renstra/indikator/umumRentra/pages/indikatorUmumRenstraAddPage'),
);
const IndikatorUmumRenstraEditPage = React.lazy(
  () => import('../features/renstra/indikator/umumRentra/pages/indikatorUmumRenstraEditPage'),
);
const IndikatorUmumRenstraListPage = React.lazy(
  () => import('../features/renstra/indikator/umumRentra/pages/indikatorUmumRenstraListPage'),
);
const TargetRenstra = React.lazy(() => import('../features/renstra/pages/TargetRenstra'));
...
const RenstraTabelProgramFormWrapper = React.lazy(
  () => import('../features/renstra/program/components/RenstraTabelProgramFormWrapper'),
);
...
const RenstraTabelSubKegiatanForm = React.lazy(
  () => import('../features/renstra/subkegiatan/components/RenstraTabelSubKegiatanForm'),
);
const RenstraTabelSubKegiatanListPage = React.lazy(
  () => import('../features/renstra/subkegiatan/pages/RenstraTabelSubKegiatanListPage'),
);
...
const RenstraTabelSubKegiatanEditPage = React.lazy(
  () => import('../features/renstra/subkegiatan/pages/RenstraTabelSubKegiatanEditPage'),
);
...
const renstraRoutes = [
  ...
  // Reviu Konsistensi Cascading Renstra
  {
    path: 'renstra/review-konsistensi',
    element: <RenstraReviewKonsistensiListPage />,
  },
  {
    path: 'renstra/review-konsistensi/add',
    element: <RenstraReviewKonsistensiAddPage />,
  },
  {
    path: 'renstra/review-konsistensi/edit/:id',
    element: <RenstraReviewKonsistensiEditPage />,
  },
  ...
  {
    path: 'renstra/tabel/arah-kebijakan/history/:id',
    element: <RenstraTabelArahKebijakanHistoryPage />,
  },
