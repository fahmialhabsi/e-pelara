...
module.exports = (sequelize, DataTypes) => {
  class IndikatorArahKebijakan extends Model {
    static associate(models) {
      this.belongsTo(models.ArahKebijakan, {
  ...
  IndikatorArahKebijakan.init(
    ...
    {
      sequelize,
      modelName:  "IndikatorArahKebijakan",
      tableName:  "indikatorarahkebijakans",
      underscored: true,
      timestamps:  true,
      indexes: [
        {
