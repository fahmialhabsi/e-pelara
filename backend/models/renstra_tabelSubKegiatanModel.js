  ...
  RenstraTabelSubkegiatan.init(
    {
      ...
      // Realisasi anggaran (Rp) — hasil sync dari Penatausahaan, bukan diisi manual.
      realisasi_tahun_1: { type: DataTypes.DECIMAL(20, 2), defaultValue: 0 },
      realisasi_tahun_2: { type: DataTypes.DECIMAL(20, 2), defaultValue: 0 },
      realisasi_tahun_3: { type: DataTypes.DECIMAL(20, 2), defaultValue: 0 },
      realisasi_tahun_4: { type: DataTypes.DECIMAL(20, 2), defaultValue: 0 },
      realisasi_tahun_5: { type: DataTypes.DECIMAL(20, 2), defaultValue: 0 },
      realisasi_tahun_6: { type: DataTypes.DECIMAL(20, 2), defaultValue: 0 },
      realisasi_akhir_renstra: { type: DataTypes.DECIMAL(20, 2), defaultValue: 0 },
      realisasi_synced_at: { type: DataTypes.DATE, allowNull: true },
