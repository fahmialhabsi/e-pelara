...
router.post(
  '/v2/:id/recompute-mismatch',
  verifyToken,
  allowRoles(WRITE_ROLES),
  govCtrl.recomputeMismatch,
);
// Data Fix & Mapping Engine
router.get(
  '/v2/:id/data-fix/summary',
  verifyToken,
  allowRoles(READ_ROLES),
  govCtrl.getDataFixSummary,
);
router.post(
...
router.post(
  '/v2/:id/items/bulk-validate',
  verifyToken,
  allowRoles(WRITE_ROLES),
  govCtrl.bulkValidateItems,
);
router.put(
  '/v2/:id/items/:itemId',
  verifyToken,
...
router.get(
  '/v2/:id/validation/mismatch',
  verifyToken,
  allowRoles(READ_ROLES),
  govCtrl.getValidationMismatch,
);
...
router.get(
  '/dropdowns/sub-kegiatan',
  verifyToken,
  allowRoles(READ_ROLES),
  govCtrl.dropdownSubKegiatan,
);
