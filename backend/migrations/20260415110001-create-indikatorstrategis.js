...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("indikatorstrategis", {
      id: {
      ...
      strategi_id: {
        type: Sequelize.INTEGER,
        allowNull: true,
        references: { model: "strategi", key: "id" },
        onUpdate: "CASCADE",
        onDelete: "SET NULL",
      },
    ...
    await queryInterface.addIndex("indikatorstrategis", {
      unique: true,
  ...
  async down(queryInterface) {
    await queryInterface.dropTable("indikatorstrategis");
  },
};
