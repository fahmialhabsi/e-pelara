...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("indikator_prioritas_daerah", {
      id: {
        type: Sequelize.UUID,
      ...
      prioritas_daerah_id: {
        type: Sequelize.UUID,
        allowNull: false,
        references: { model: "prioritas_daerah", key: "id" },
        onUpdate: "CASCADE",
        onDelete: "RESTRICT",
      },
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable("indikator_prioritas_daerah");
  },
};
