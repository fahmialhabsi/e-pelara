...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("renstra_tabel_tujuan", {
      id: {
      ...
      kode_tujuan: { type: Sequelize.STRING(50), allowNull: true },
      nama_tujuan: { type: Sequelize.STRING(255), allowNull: true },
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable("renstra_tabel_tujuan");
  },
};
